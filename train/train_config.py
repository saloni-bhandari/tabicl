...
def build_parser():
    ...
    parser.add_argument("--max_features", type=int, default=20, help="The maximum number of features")
    ...
    parser.add_argument("--max_seq_len", type=int, default=100, help="Maximum samples per dataset")
    parser.add_argument(
        "--log_seq_len",
        default=False,
        type=str2bool,
    ...
    parser.add_argument("--embed_dim", type=int, default=16, help="Base embedding dimension")
    parser.add_argument("--col_num_blocks", type=int, default=3, help="Number of blocks in column embedder")
    parser.add_argument("--col_nhead", type=int, default=2, help="Number of attention heads in column embedder")
    ...
    parser.add_argument("--row_nhead", type=int, default=2, help="Number of attention heads in row interactor")
    ...
    # ICL Config
    parser.add_argument("--icl_num_blocks", type=int, default=3, help="Number of transformer blocks in ICL predictor")
    parser.add_argument("--icl_nhead", type=int, default=2, help="Number of attention heads in ICL predictor")
    ...
    ###### Checkpointing ######################################################
    ###########################################################################
    parser.add_argument("--checkpoint_dir", default="balls", type=str, help="Directory for checkpoint saving and loading")
